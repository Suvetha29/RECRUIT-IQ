    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing:border-box; margin:0; padding:0; }
        ...
        /* ✅ AI Report Panel — identical to AllApplicants */
        ...
        <div className="main-area">
          <div className="topbar">
            ...
            <div className="topbar-right">
              <button onClick={() => navigate(`/hr/assessment/${jobId}`)}
                    ...
                    {filtered.map((app, i) => {
                      ...
                      return (
                        <React.Fragment key={app.application_id}>
                            ...
                            <td>
                              {ai ? (
                                <span className="score-pill" style={{
                                  background: ai.recommendation==='hire'?'#dcfce7':'#fee2e2',
                                  color:      ai.recommendation==='hire'?'#16a34a':'#dc2626',
                                }}>
                                  🤖 {ai.ai_score}%
                                </span>
                              ) : <span style={{color:'#d1d5db',fontSize:'12px'}}>—</span>}
                            ...
                            <td>
                              <div className="td-acts">
                                <a href={app.resume_url} target="_blank" rel="noopener noreferrer"
                                  className="btn-xs" style={{background:'#eff6ff',color:'#2563eb'}}>📄 Resume</a>
                                {app.meet_link && (
                                  <a href={app.meet_link} target="_blank" rel="noopener noreferrer"
                                    className="btn-xs" style={{background:'#f5f3ff',color:'#7c3aed'}}>🎥 Join</a>
                                )}
                                {/* ✅ Recording always visible, not just on interview status */}
                                <button className="btn-xs" style={{background:'#f0fdf4',color:'#16a34a'}}
                                  onClick={()=>setRecordingModal(app)}>🎙️ Recording</button>
                                {app.status==='hired' && (
                                  <button className="btn-xs" style={{background:'#fefce8',color:'#854d0e'}}
                                    onClick={()=>generateOfferLetter(app.application_id,app.candidate_name)}>📄 Offer</button>
                                )}
                                <button className="btn-xs" style={{background:'#f3f4f6',color:'#6b7280'}}
                          ...
                          {/* ✅ EXPANDED ROW — full AI report matching AllApplicants */}
                          {isExpanded && (
                              ...
                              <td colSpan={8}>
                                <div className="exp-body">
                                  <div className="exp-grid">
                                    ...
                                    {/* ✅ RIGHT: Full AI Report — identical to AllApplicants */}
                                    <div>
                                      {ai ? (
                                          ...
                                          <div className="ai-body">
                                            ...
                                            <div className="ai-sw-row">
                                              <div className="ai-sw-card ai-sw-card-hire">
                                                <div className="ai-sw-head" style={{color:'#16a34a'}}><span>💪</span> Strengths</div>
                                              ...
                                              <div className="ai-sw-card ai-sw-card-reject">
                                                <div className="ai-sw-head" style={{color:'#dc2626'}}><span>⚠️</span> Weaknesses</div>
                                                <div className="ai-sw-content">
      ...
      {aiResult && (
        <div style={mS.overlay}>
          <div style={{...mS.box,maxWidth:'520px'}}>
            <div style={{...mS.header, background: aiResult.recommendation==='hire'
